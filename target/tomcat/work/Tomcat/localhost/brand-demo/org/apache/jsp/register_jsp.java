 ...
 * Generated at: 2023-03-24 07:21:42 UTC
...
public final class register_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        // 在请求地址后面加上随机数，这样浏览器就会认为这是不一样的请求的，达到点击刷新验证码的目的，避免浏览器缓存\r\n");
      out.write("        // 相当于每点击一下 重新生成一次生成验证码的相应 checkCodeServlet\r\n");
      out.write("        // 可以复制以下url体验以下\r\n");
      out.write("        // http://localhost:8080/brand-demo/checkCodeServlet   如果浏览器不关闭缓存，那可能每次可能都是得到相同的图片\r\n");
      out.write("        // http://localhost:8080/brand-demo/checkCodeServlet?2131231231   问号后面的数字可以随意更换，每更换一次就刷新一次图片\r\n");
